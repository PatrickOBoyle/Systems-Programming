...
/*
    ...
    If I was working on this again I would
    have create a better printing system
    to make it clear which #'d bit was set
    instead of having to count them manually,
